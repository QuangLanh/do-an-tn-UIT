  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <NutBam onClick={handleExportPDF} isLoading={isExporting} variant="success">
      ...
      <div ref={reportRef} className="space-y-6 bg-white dark:bg-gray-900 p-8">
        ...
        {/* Top Products */}
        <TheThongTin title="Top 10 sản phẩm bán chạy">
          <BangDuLieu data={topProducts} columns={topProductsColumns} />
        </TheThongTin>

        {/* Daily Sales - Show last 10 days for PDF */}
        <TheThongTin title="Doanh thu 10 ngày gần nhất">
          <BangDuLieu data={dailySales.slice(-10)} columns={dailySalesColumns} />
        </TheThongTin>

        {/* Analysis */}
        <TheThongTin title="Phân tích và nhận xét">
