...
export const BieuMauDonHang = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      const orderData = {
        id: existingOrder?.id,
        items,
        customerName: customerType === 'retail' ? '' : customerName,
        customerPhone: customerType === 'retail' ? '' : customerPhone,
        notes,
  ...
  <TheThongTin title="Sản phẩm trong đơn hàng">
      ...
      {/* Nếu không dùng barcode thì tìm kiếm sản phẩm theo tên và thêm thủ công */}
